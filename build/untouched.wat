(module
 ...
 (func $~lib/array/Array<Point>#constructor (; 8 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/internal/memory/memcpy (; 10 ;) (type $iii_) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  block $break|0
 ...
 (func $~lib/internal/memory/memmove (; 11 ;) (type $iii_) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  local.get $0
  local.get $1
  i32.eq
 ...
 (func $~lib/array/Array<Point>#__set (; 14 ;) (type $iii_) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  ...
  block $~lib/internal/arraybuffer/STORE<Point,Point>|inlined.0
   local.get $3
   local.set $5
   local.get $1
   local.set $6
 ...
 (func $assembly/index/System#constructor (; 15 ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.eqz
  if
   i32.const 4
     ...
     block $break|1
      ...
      loop $repeat|1
       ...
       block
        local.get $2
        local.get $11
        call $~lib/array/Array<Point>#__unchecked_get
        local.set $12
        local.get $6
        local.get $12
        f64.load
 ...
 (func $assembly/index/getBody (; 24 ;) (type $ii) (param $0 i32) (result i32)
  ...
  local.set $1
  local.get $0
  block $~lib/array/Array<Point>#get:length|inlined.3 (result i32)
   local.get $1
   local.set $2
   local.get $2
   i32.load offset=4
