...
let rk = 0.0;
function Uranus() {
    return new Body(1.28943695621391310e+01 + (rk++), -1.51111514016986312e+01 + (rk++), -2.23307578892655734e-01, 2.96460137564761618e-03 * DAYS_PER_YEAR, 2.37847173959480950e-03 * DAYS_PER_YEAR, -2.96589568540237556e-05 * DAYS_PER_YEAR, 4.36624404335156298e-05 * SOLAR_MASS);
}
function Neptune() {
